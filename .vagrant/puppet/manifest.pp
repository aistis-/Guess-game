...
nginx::resource::location { 'game.dev-php':
  ensure              => 'present',
  index_files         => [
    'app_dev.php',
    'app.php',
...
nginx::resource::vhost { 'xhprof.game.dev':
  ensure       => present,
  server_name  => ['xhprof.game.dev'],
...
nginx::resource::location { 'xhprof.game.dev-php':
  ensure              => 'present',
  index_files         => ['index.php', 'index.html'],
  vhost               => 'xhprof.game.dev',
  location            => '~ \.php$',
  proxy               => undef,
  try_files           => ['$uri', '$uri/', '/index.php?$args'],
  www_root            => '/var/www/vendor/facebook/xhprof/xhprof_html/',
